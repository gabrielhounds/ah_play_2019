...
function init() {
    ...
    var ctaBg, ctaText, ctaHolder, overlay, ahLogo, logoTextures, instructionText, cabLogo, cabCatch, cabA, cabBite, cabBg, cabCandy1, cabCandy2, cabCandy3, cabCandy4, intro, cabLogoFull, cabLogoFullEnd;
    var main, bgHolder, candyHolder, fgHolder, airheadHolder, hitRect;
    var sky_bg, buildings, trees, hedges, street, lightpoles;
    var candy0, candy1, candy2, candy3, candy4, candy5, candy6, candy7, candy8, candy9, candy10, candy11, candy12, candy13;
    ...
    loadingText.style = {
        fill: "0xFFFFFF",
        fontSize: "20px",
        fontFamily: "uniform_roundedbold, sans-serif"
    };
    ...
    function initAudio() {
        bgSound = new Howl({
            src: ["sounds/bg-sound.webm", "sounds/bg-sound.mp3"],
            volume: .4,
            loop: true
        });
        flapSound = new Howl({
            src: ["sounds/jump-sound.webm", "sounds/jump-sound.mp3"],
            volume: .5
        });
        buttonSound = new Howl({
            src: ["sounds/button-sound.webm", "sounds/button-sound.mp3"],
            volume: .5
        });
        eatSound = new Howl({
            src: ["sounds/eat-sound.webm", "sounds/eat-sound.mp3"],
            volume: .5
        });
        loseSound = new Howl({
            src: ["sounds/lose-sound.webm", "sounds/lose-sound.mp3"],
            volume: .5
        });
        winSound = new Howl({
            src: ["sounds/win-sound.webm", "sounds/win-sound.mp3"],
            volume: .5
        });
        overSound = new Howl({
            src: ["sounds/over-sound.webm", "sounds/over-sound.mp3"],
            volume: .5
        });
        var audioCount = 0;
        ...
        if (playing === false) {
            ...
            for (var i = 0; i < candies.length; i++) {
                if (screenSize === "mobile") {
                    t.set(candies[i], {
                        pixi: {
                            x: Utils.random(stageW, stageW * 4),
                            y: Utils.random(50, stageH - 100)
                        }
                    })
                } else {
                    t.set(candies[i], {
                        pixi: {
                            x: Utils.random(stageW / 2, stageW * 2),
                            y: Utils.random(50, stageH - 100)
                        }
                    })
                }
            }
            t.set([heart1, heart2, heart3], {
                pixi: {
                    alpha: 1
                }
            });
    ...
    function handleGameOver(won) {
        ...
        .from(cabLogoEnd,		0.8, {pixi:{scale:0.3, alpha:0}, ease:Elastic.easeOut})
        ...
        .from(yourScoreText, 	0.6, {pixi:{y:'+=40',  alpha:0}, ease:Elastic.easeOut}, '-=0.75')
        ...
        function setUpEndCta() {
            endCtaHolder1.on('mouseover', function(e){
				t.to(endCtaBg1, 0.6, {pixi:{scale:1.1}, ease:Elastic.easeOut});
			...
			endCtaHolder2.on('mouseover', function(e){
				t.to(endCtaBg2, 0.6, {pixi:{scale:1.1}, ease:Elastic.easeOut});
    ...
    function handleFlap() {
        if (playing === true) {
            ...
            t.to([rightLeg, leftLeg, head, rightArm, leftArm, airBody], .9, {
                pixi: {
                    rotation: 0
                },
                delay: 1,
    ...
    function candyScroll(delta) {
		...
		candy6.rotation -= 0.005;
      	candy7.rotation -= 0.015;
      	candy8.rotation -= 0.002;
      	candy9.rotation += 0.003;
      	candy10.rotation -= 0.006;
      	candy11.rotation -= 0.001;
      	candy12.rotation -= 0.013;
      	candy13.rotation -= 0.02;
    ...
    function buildStage() {
		...
		.from(cabLogo, 		0.8, {pixi:{scale:0.3, alpha:0}, ease:Elastic.easeOut})
    ...
    function setPosition() {
        ...
        cabCatch.anchor.set(.5);
        cabA.anchor.set(.5);
        cabBite.anchor.set(.5);
        cabBg.anchor.set(.5);
        cabCandy1.anchor.set(.5);
        cabCandy2.anchor.set(.5);
        cabCandy3.anchor.set(.5);
        cabCandy4.anchor.set(.5);
		...
		cabLogo.addChild(cabLogoFull);
		cabLogoFull.anchor.set(0.5);
        ...
        if (screenSize === "desktop") {
            ...
            cabLogo.position.set(stageW / 2, 210);
            ...
            if (screenHeight === "small") {
                ...
                cabLogo.scale.set(.35);
                cabLogo.position.set(stageW / 2, 120);

                ctaHolder.scale.set(.6);
                ...
                overlay.position.set(stageW - overlay.width / 2, stageH - 80);
                cabLogo.scale.set(.5);
                cabLogo.position.set(stageW / 2, 135);
        ...
        candy5.anchor.set(.5);
        candy6.anchor.set(.5);
        candy7.anchor.set(0.5);
      	candy8.anchor.set(0.5);
      	candy9.anchor.set(0.5);
      	candy10.anchor.set(0.5);
      	candy11.anchor.set(0.5);
      	candy12.anchor.set(0.5);
      	candy13.anchor.set(0.5);
        ...
        candyHolder.addChild(candy7);
     	...
     	candyHolder.addChild(candy10);
      	...
      	candyHolder.addChild(candy13);


	  	candies = [candy0, candy1, candy2, candy3, candy4, candy5, candy6, candy7, candy8, candy9, candy10, candy11, candy12, candy13];
		for (var i = 0; i < candies.length; i++) {
            if (screenSize === "mobile") {
                t.set(candies[i], {
                    pixi: {
                ...
                t.set(candies[i], {
                    pixi: {
                        x: Utils.random(stageW, stageW * 2),
                        y: Utils.random(50, stageH - 100)
                    }
                })
            }
        ...
        endCtaBg1.anchor.set(.5);
        endCtaBg2.anchor.set(.5);
        endCtaText1.anchor.set(.5);
        endCtaText2.anchor.set(.5);
        ...
        cabLogoEnd.addChild(cabLogoFullEnd);
        cabLogoFullEnd.anchor.set(0.5);
		cabLogoEnd.scale.set(0.54);


        ahLogoEnd.anchor.set(.5);
        ahLogoEnd.animationSpeed = .3;
        ahLogoEnd.loop = false;
        if (screenSize === "desktop") {

            //cabLogoEnd.scale.set(.42);
            //cabLogoEnd.position.set(stageW / 3 - cabLogoEnd.width / 2 - 10, 26);
			cabLogoEnd.position.set(421, 100);
            ...
            endCtaHolder1.scale.set(.75);
            endCtaHolder2.scale.set(.75);
            ...
            if (screenHeight === "small") {
                ...
                ahLogoEnd.scale.set(.4);
                ahLogoEnd.position.set(stageW / 2, stageH - ahLogoEnd.height / 2)
            } else {


                cabLogoEnd.scale.set(.42);
                cabLogoEnd.position.set(stageW / 2, 120);
                ...
                endSubhead.style.fontSize = "28px";
                endSubhead.position.set(stageW / 2 - endSubhead.width / 2, stageH / 2 - endSubhead.height);
                endCtaHolder1.scale.set(.55);
                endCtaHolder2.scale.set(.55);
                
                endCtaHolder1.position.set(stageW / 2 - endCtaHolder1.width / 2 - 10, stageH / 2 + 50);
                endCtaHolder2.position.set(stageW / 2 + endCtaHolder2.width / 2 + 10, stageH / 2 + 50);
                
                ahLogoEnd.scale.set(.6);
                ahLogoEnd.position.set(stageW / 2, stageH - ahLogoEnd.height / 1.75)
            }
        }
    ...
    function setUp() {
		...
		cabLogoFull = new PIXI.Sprite(resources['images/cab/cab_logo.png'].texture);
        ...
        overlay = new PIXI.Sprite(resources["images/cab/intro_overlay.png"].texture);
        ...
        candy7 			= new PIXI.Sprite(resources['images/cab/candy_07.png'].texture);
      	candy8 			= new PIXI.Sprite(resources['images/cab/candy_08.png'].texture);
        candy9 			= new PIXI.Sprite(resources['images/cab/candy_09.png'].texture);
      	candy10 		= new PIXI.Sprite(resources['images/cab/candy_10.png'].texture);
        candy11 		= new PIXI.Sprite(resources['images/cab/candy_11.png'].texture);
        candy12 		= new PIXI.Sprite(resources['images/cab/candy_12.png'].texture);
        candy13 		= new PIXI.Sprite(resources['images/cab/candy_13.png'].texture);
        ...
        cabLogoFullEnd 	= new PIXI.Sprite(resources['images/cab/cab_logo_endframe.png'].texture);
        ...
        overlayEnd 	= new PIXI.Sprite(resources['images/cab/endFrame_bg.png'].texture);
        //overlayEndMobile = new PIXI.Sprite(resources['images/cab/endFrame_bg_mobile.png'].texture);
    ...
    loader.add(["images/cab/buildings.png", "images/cab/hedge.png", "images/cab/lightpost_foreground.png", "images/cab/road.png", "images/cab/sky.png", "images/cab/trees.png", "images/cab/overlayBg_@2x.png", "images/cab/intro_overlay.png", "images/cab/ah_body.png", "images/cab/ah_head_00.png", "images/cab/ah_head_01.png", "images/cab/ah_head_02.png", "images/cab/ah_leftArm.png", "images/cab/ah_leftLeg.png", "images/cab/ah_pelvis.png", "images/cab/ah_rightArm.png", "images/cab/ah_rightLeg.png", "images/cab/candy_00.png", "images/cab/candy_01.png", "images/cab/candy_02.png", "images/cab/candy_03.png", "images/cab/candy_04.png", "images/cab/candy_05.png", "images/cab/candy_06.png" , "images/cab/candy_07.png", "images/cab/candy_08.png", "images/cab/candy_09.png", "images/cab/candy_10.png", "images/cab/candy_11.png", 'images/cab/candy_12.png', 'images/cab/candy_13.png',"images/cab/heart.png", "images/cab/cta_bg.png", "images/cab/logo00.png", "images/cab/logo01.png", "images/cab/logo02.png", "images/cab/logo03.png", "images/cab/logo04.png", "images/cab/logo05.png", "images/cab/logo06.png", "images/cab/logo07.png", "images/cab/logo08.png", "images/cab/logo09.png", "images/cab/logo10.png", "images/cab/logo11.png", "images/cab/logo12.png", "images/cab/cab_catch.png", "images/cab/cab_a.png", "images/cab/cab_bite.png", "images/cab/cab_bg.png", "images/cab/cab_candy1.png", "images/cab/cab_candy2.png", "images/cab/cab_candy3.png", "images/cab/cab_candy4.png", "images/cab/endOverlay.png", "images/cab/ashleigh.png", "images/cab/candy_scoreIcon.png", "images/cab/cab_logo.png", "images/cab/cab_logo_endframe.png", "images/cab/endFrame_bg.png", 'images/cab/endFrame_bg_mobile.jpg' ] ) .on("progress", loadProgressHandler).load(setUp);
