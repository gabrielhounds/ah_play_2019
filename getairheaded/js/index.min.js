...
function init() {
    ...
    var ctaBg, ctaText, ctaHolder, overlay, ahLogo, logoTextures, instructionText, gaLogo, gaGet, gaAirheaded, gaBg, gaCandy1, gaCandy2, gaCandy3, gaCandy4, intro, introOverlay;
    var main, bgHolder, candyHolder, fgHolder, airheadHolder, hitRect, stageHit;
    var sky_bg;
    var candy0, candy1, candy2, candy3, candy4, candy5, candy6, candy7, candy8;
    ...
    function handleGameOver(won) {
        ...
        .from(gaLogoEnd, 		0.8, {pixi:{scale:0.3, alpha:0}, ease:Elastic.easeOut})
    ...
    function resetEnemy() {
        t.set(enemy, {
            pixi: {
                x: Utils.random(-1200, stageW + 1200),
                y: Utils.random(stageH + 800, stageH + 3500)
            }
        });
    ...
    function handleEnemy() {
        ...
        if (enemy.scale.x < .5 && enemy.scale.x > .47) {
    ...
    function resetCandyPos3() {
        ...
        candyBlur3.blur = 10;
        candy3.gotoAndStop(Utils.random(0, 11))
    }
    var candyTime = 0;
    ...
    function handleCandy(delta) {
        ...
        if (candy1.scale.x < .6 && candy1.scale.x > .35) {
        ...
        if (candy2.scale.x < .6 && candy2.scale.x > .35) {
        ...
        if (candy3.scale.x < .6 && candy3.scale.x > .35) {
    ...
    function handleBg() {
        if (sky_bg.scale.x > .8) {
            sky_bg.scale.x = sky_bg.scale.y -= 4e-4
        }
    }
    ...
    function handleAirHead() {
        ...
        if (!isMobile) {
            ...
            leftLeg.rotation = dx / 10.5 * (Math.PI / 180) + .25;
            ...
            leftLeg.rotation = dx / 5.5 * (Math.PI / 180) + .25;
    ...
    function setUpGame() {
		...
		//.to(introOverlay, 		0.4, {pixi:{alpha:0}, ease:Power2.easeOut}, '-=0.4')
    ...
    function buildStage() {
        tlIntro.add('begin')
		//.from(introOverlay, 0.5, {pixi:{alpha:0}, ease:Power2.easeOut}, '+=1.0')
		//.from(main, 		0.5, {pixi:{alpha:0}}, '+=1.0')
		.from(main, 0.5, {pixi:{alpha:0}, ease:Power2.easeOut})

        .from(overlay, 		0.7, {pixi:{x:'+=40', alpha:0}, ease:Elastic.easeOut}, '-=0.5')
		.from(instructionText, 0.4, {pixi:{y:'+=40', alpha:0},ease:Elastic.easeOut}, '-=0.6')

		.from(gaLogo, 		0.8, {pixi:{scale:0.3, alpha:0}, ease:Elastic.easeOut})
    ...
    function setPosition() {
        ...
        gaGet.anchor.set(.5);
        gaAirheaded.anchor.set(.5);
        gaBg.anchor.set(.5);
        gaCandy1.anchor.set(.5);
        gaCandy2.anchor.set(.5);
        gaCandy3.anchor.set(.5);
        gaCandy4.anchor.set(.5);
        ...
        gaLogo.addChild(gaLogoFull);
		gaLogoFull.anchor.set(0.5);

        overlay.width = 961 / 2;
        overlay.height = 1e3 / 2;
        ctaBg.anchor.set(.5);
        ...
        if (screenSize === "desktop") {
            ...
            //gaLogo.scale.x = gaLogo.scale.y = .75;
            ...
            overlay.alpha = 0;
            ahLogo.alpha = 0;
            gaLogo.position.set(stageW / 2, 200);
            ctaHolder.position.set(stageW / 2, stageH / 2 + 145)
        } else if (screenSize === "tablet") {
            overlay.position.set(stageW / 3 * 1.75, 0);
            gaLogo.scale.set(.5);
            gaLogo.position.set(stageW / 3 - gaLogo.width / 2 - 20, 60);
            ...
            if (screenHeight === "small") {
                ...
                overlay.position.set(stageW - overlay.width / 2, stageH - 80);
                gaLogo.scale.set(.45);
                gaLogo.position.set(stageW / 2, 160);
        ...
        t.set(candy1, {
            pixi: {
                x: Utils.random(-200, stageW / 2),
                y: Utils.random(stageH + 250, stageH + 2e3)
            }
        });
        candy2.scale.x = candy2.scale.y = Utils.random(minCandyScale, maxCandyScale);
        t.set(candy2, {
        ...
        t.set(enemy, {
            pixi: {
                x: Utils.random(0, stageW),
                y: Utils.random(stageH + 1e3, stageH + 5e3)
            }
        });
        ...
        gaLogoEnd.addChild(gaLogoFullEnd);
        gaLogoFullEnd.anchor.set(0.5);
		//gaLogoEnd.scale.set(0.54);

        if (screenSize === "desktop") {
            //gaLogoEnd.scale.set(.42);
            gaLogoEnd.position.set(stageW / 3, 100);
	        ...
	        overlayEnd.setTexture(resources['images/endFrame_bg_mobile.jpg'].texture);
			overlayEnd.width = stageW;
            overlayEnd.height = stageH;

            if (screenHeight === "small") {
                //gaLogoEnd.scale.set(.2);
                gaLogoEnd.position.set(stageW / 2, 120);
    ...
    function setUp() {
        ...
        overlay = new PIXI.Sprite(resources["images/intro_overlay.png"].texture);
        ...
        gaLogoFull = new PIXI.Sprite(resources['images/ga_logo_2.png'].texture);
        ...
        candyTextures = [resources["images/candy_01.png"].texture, resources["images/candy_02.png"].texture, resources["images/candy_03.png"].texture, resources["images/candy_04.png"].texture, resources["images/candy_05.png"].texture, resources["images/candy_06.png"].texture, resources['images/candy_07.png'].texture, resources['images/candy_08.png'].texture, resources['images/candy_09.png'].texture, resources['images/candy_10.png'].texture, resources['images/candy_11.png'].texture];
        ...
        gaLogoFullEnd 	= new PIXI.Sprite(resources['images/ga_logo_end_2.png'].texture);
        ...
        endCtaText2 = new PIXI.Text(" Find near me ");
        ahLogoEnd = new PIXI.extras.AnimatedSprite(logoTextures);
        overlayEnd = new PIXI.Sprite(resources["images/endFrame_bg.png"].texture);
    ...
    loader.add(["images/sky_bg_test.jpg", "images/sky_bg.jpg", "images/heart.png", "images/candy_scoreIcon.png", "images/candy_00.png", "images/candy_01.png", "images/candy_02.png", "images/candy_03.png", "images/candy_04.png", "images/candy_05.png", "images/candy_06.png","images/candy_07.png", "images/candy_08.png", "images/candy_09.png", "images/candy_10.png", "images/candy_11.png", "images/cat.png", "images/duck.png", "images/flamingo.png", "images/beachBall.png", "images/ah_head_00.png", "images/ah_head_01.png", "images/ah_head_02.png", "images/ah_lowerLeftArm.png", "images/ah_lowerLeftLeg.png", "images/ah_lowerRightArm.png", "images/ah_lowerRightLeg.png", "images/ah_pelvis.png", "images/ah_torso.png", "images/ah_upperLeftArm.png", "images/ah_upperLeftLeg.png", "images/ah_upperRightArm.png", "images/ah_upperRightLeg.png", "images/cta_bg.png", "images/logo00.png", "images/logo01.png", "images/logo02.png", "images/logo03.png", "images/logo04.png", "images/logo05.png", "images/logo06.png", "images/logo07.png", "images/logo08.png", "images/logo09.png", "images/logo10.png", "images/logo11.png", "images/logo12.png", "images/overlayBg_@2X.png", "images/ga_airheaded.png", "images/ga_get.png", "images/ga_bg.png", "images/ga_candy1.png", "images/ga_candy2.png", "images/ga_candy3.png", "images/ga_candy4.png", "images/endOverlay.png", "images/ga_logo_2.png", "images/ga_logo_end_2.png", "images/overlay.png", "images/endFrame_bg.png", "images/endFrame_bg_mobile.jpg", "images/intro_overlay.png"]).on("progress", loadProgressHandler).load(setUp);
    var initTouch = false;
