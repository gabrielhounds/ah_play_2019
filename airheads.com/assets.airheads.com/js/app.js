! function(e, t, i) {
    ...
    e.airheads || (e.airheads = {}), t.airheads || (t.airheads = {
        ...
        o.addClass(t)
    }), e(document).on("airheadsModuleInit", n), document.querySelector(".hero_inner video").play()
}(jQuery, window),
function(e, t, i) {
    "use strict";
...
function(e, t, i) {
    ...
    var n, o = e(window),
        ...
        h = "hero.gif";
    ! function() {
        "/" === s ? (r.first().addClass("global-header_nav-item--active"), l = "home-page") : "/tagged/crafts" === s ? (c = e(".hero"), l = "crafts-page", o.width() <= u && (h = "hero-m.jpg"), c.html('<div class="hero_slide"><img src="//assets.airheads.com/img/crafts/' + h + '" alt=""></div>'), r.each(function() {
            var t = e(this);
            if (t.attr("href") === s) return t.addClass("global-header_nav-item--active"), !1
...
function(e, t) {
    ...
    var o, a = {},
        r = "http://airheads.channelsight.com/Feeds/Get?format=json&source=MultipleSku&countryCode=en-US&Brand=airheads&skulist=";
    ! function() {
        o = e("[data-upc]");
        var t = [];
        o.each(function(i, n) {
...
function(e, t, i) {
    ...
    function n(i, n) {
        ...
        return u.el = i, u.$el = e(i), u.$video = u.$el.find(".youtube-player_video"), u.$overlay = u.$el.find(".youtube-player_overlay"), u.$iframe = u.$el.find("iframe"),
            function() {
                void 0 === n && (n = {}), u.options = e.extend({}, s, n), u.options.videoId = u.$video.data("video"), d = "http://www.youtube.com/embed/" + u.options.videoId + "?wmode=opaque&rel=0&fs=1&showinfo=" + u.options.showInfo + "&autoplay=" + u.options.autoplay, r(), window.setTimeout(function() {
                    o()
                }, 2e3)
            }(), u.$el
    }
...
function(e, t, i) {
    ...
    function n(i) {
        function n() {
            o.show(), a.show(), r.show(), t.publish("loadIFrameSrc"), t.publish("setContentWidthIframe"), e(window).trigger("scroll"), t.publish("windowResize")
        }
        var o = e(".hero"),
            a = e(".hero-mobile"),
            r = e(".main_content");
...
function(e, t, i) {
    ...
    function n(i) {
        ...
        var s = i.find(".global-header_hamburger-menu"),
            d = {};
        ! function() {
            i.hasClass("global-header--not-sticky") || a(), r()
        }()
    }
    ...
    function n(t) {
        function i() {
            _.on("submit", function(e) {
                e.preventDefault(), s(""), n(), r() ? s(y.join("<br>")) : d()
            })
        }
        ...
        function d() {
            ...
            var t = "http://productlocator.infores.com/productlocator/servlet/ProductLocatorEngine?clientid=245&productfamilyid=ARHD&zip=" + g + "&searchradius=" + m + "&producttype=" + v + "&productid=" + w + "&storespagenum=" + S;
            e.ajax({
                url: t,
                cache: !0
            }).done(function(t) {
                var i = e.parseXML(t),
                    n = e(i).find("STORE"),
                    o = "";
                if (N = 0, (T = parseInt(e(i).find("STORES").last().attr("COUNT"), 10)) < 1 || isNaN(T)) return s("Bummer, no stores near you have this item. Check back again soon!"), M.removeClass("_slide-down"), !1;
                p = 10 * (S - 1) + 1, n.each(function(t) {
                    var i = e(this),
                        n = i.find("NAME").text(),
                        a = i.find("PHONE").text(),
                        r = i.find("ADDRESS").text(),
                        s = i.find("CITY").text(),
                        d = i.find("STATE").text(),
                        u = i.find("ZIP").text(),
                        c = i.find("LATITUDE").text(),
                        l = i.find("LONGITUDE").text();
                    o += "<div class='store'><h5>" + (p + t) + ". " + n + "</h5><p class='address'>" + r + "</p><p><span class='city'>" + s + "</span>, <span class='state'>" + d + "</span> <span class='zip'>" + u + "</span></p><p class='phone'><a href='tel:" + a.replace(/[^0-9.]/g, "") + "'>" + a + "</a></p><a class='direction' target='_blank' href='https://maps.google.com/?daddr=" + r + "," + s + "," + d + " " + u + "'><span>Get Directions</span></a><input type='hidden' class='latitude' value=" + c + "/><input type='hidden' class='longitude' value=" + l + "/><hr /></div>", N += 1
                }), f = N + 10 * (S - 1), S > 1 && P.show(), f < T && I.show(), A.html(o), h(), u()
            })
        }

        function u() {
            e(".result-index-start").html(p), e(".result-index-end").html(f), e(".result-length").html(T), e(".result-distance").html(m), e(".result-zip").html(g)
        }
        ...
        function h() {
            ...
            if (A.children().length > 0) {
                for (e(".store").each(function(t) {
                        s.push(e(this).find(".latitude").val().replace("/", "")), d.push(e(this).find(".longitude").val().replace("/", "")), u.push("<span>" + e(this).find("h5").html() + "</span><br />" + e(this).find(".address").html() + "<br />" + e(this).find(".city").html() + ", " + e(this).find(".state").html() + " " + e(this).find(".zip").html() + "<br /><a target='_blank' href='" + e(this).find(".direction").attr("href") + "'>Get Directions</a>")
                    }), a = 0; a < s.length; a++) {
                    var c = new google.maps.LatLng(s[a], d[a]);
                    i.extend(c), r = new google.maps.Marker({
                        position: c,
                        map: t,
    ...
    function n(t) {
        ...
        function n() {
            e.ajax({
                ...
                r.html('<p class="single-post_error">Error loading content.</p>')
            }).done(function(e) {
                t.replaceWith(e)
            }).always(function() {
                t.show()
        ...
        function o() {
            r.find(".avatar").attr("src", function() {
        ...
        var r = t.find(".single-post_inner"),
            s = "/" !== window.location.pathname ? window.location.pathname : "",
            d = s.split("/"),
            u = "-project";
        ! function() {
            i(), a(), e.airheads.sharePost(r)
        }()
    }
    ...
    function n(t) {
        ...
        function d() {
            w.html(""), p.addClass("is-loading"), e.ajax({
                ...
                }, 500), x && (i = a(i, x)), r(i), p.append(i).masonry("appended", i), window.setTimeout(function() {
                    n()
                }, 500), 0 === i.length && (o = !0), k += 1, s(o)
            }).fail(function() {
        ...
        ! function() {
            i(), s(), v.length > 0 && u(), e.airheads.sharePost(p)
        }()
    }
